...
const NegociosScreen = React.lazy(() => import("./screens/NegociosScreen.jsx"));
...
function App() {
  ...
  const addStory = async ({ author, image, video, text, zoom, focus, overlays, musicName, musicUrl, bgColor }) => {
    ...
    setStories(prev => [{
      ...
      musicName: musicName || "", musicUrl: musicUrl || null, bgColor: bgColor || null,
  ...
  const [viewingNegocioSellerUid, setViewingNegocioSellerUid] = useState(null);
  const openNegocios = (uid) => { setViewingNegocioSellerUid(uid || null); setOpenTile("negocios"); };
    ...
    <div className="w-full min-h-[100svh] flex items-center justify-center" style={{ background: "#0E1120" }}>
      ...
      <div data-theme={theme}
        ...
        {stage === "loading" ? (
          ...
          <ProfileNavContext.Provider value={{ openProfile, openMensagem, openOracao, openTestemunhos, openNegocios }}>
          ...
          <div className="flex flex-col h-full" style={{ zoom: textLarge ? 1.1 : 1 }} data-text-large={textLarge ? "" : undefined}>
            ...
            ) : openTile === "estacaoimpressao" || (tab === "estacaoimpressao" && !openTile) ? (
              <EstacaoImpressaoScreen onBack={() => { setOpenTile(null); setTab("inicio"); }} />
            ...
            ) : openTile === "negocios" || (tab === "negocios" && !openTile) ? (
              <NegociosScreen onBack={() => { setOpenTile(null); setTab("inicio"); setViewingNegocioSellerUid(null); }} sellerUid={viewingNegocioSellerUid} />
