...
export const UserContext = createContext({ uid: null, name: "Visitante", email: "", profissao: "", telefone: "", photo: null, bio: "", setPhoto: () => {}, setName: () => {}, setBio: () => {}, setTelefone: () => {}, role: "member", notificacoesAtivas: true, setNotificacoesAtivas: () => {}, possuiCarro: false, placa: "", setPossuiCarro: () => {}, setPlaca: () => {}, createdAt: null, dataConversao: "", versiculo: "", setDataConversao: () => {}, setVersiculo: () => {} });
...
export const ProfileNavContext = createContext({ openProfile: () => {}, openMensagem: () => {}, openOracao: () => {}, openTestemunhos: () => {}, openNegocios: () => {} });
