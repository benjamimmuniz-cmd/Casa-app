...
export const UserContext = createContext({ uid: null, name: "Visitante", email: "", profissao: "", photo: null, bio: "", setPhoto: () => {}, setName: () => {}, setBio: () => {}, role: "member", notificacoesAtivas: true, setNotificacoesAtivas: () => {}, possuiCarro: false, placa: "", setPossuiCarro: () => {}, setPlaca: () => {}, becomeMaster: () => Promise.resolve() });
...
export const ProfileNavContext = createContext({ openProfile: () => {}, openMensagem: () => {} });
